...
#define LCF_INTVEC0_START 0x80010000
#define LCF_INTVEC1_START 0x80012000
#define LCF_INTVEC2_START 0x80014000
...
#define LCF_STARTPTR_CPU1 0x80000500
#define LCF_STARTPTR_CPU2 0x80000520

#define LCF_STARTPTR_NC_CPU0 0xA0000000
#define LCF_STARTPTR_NC_CPU1 0xA0000500
#define LCF_STARTPTR_NC_CPU2 0xA0000520
...
derivative tc37
{
    ...
    memory pfls0
    {
        ...
        size = 128K;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80000000,           size=128K);
        map not_cached (dest=bus:sri, dest_offset=0xa0000000, reserved, size=128K);
    }
    ...
    section_layout :vtc:linear
    {
        ...
        group (ordered)
        {
            ...
            {
                section "intvec_btl" (size=0x10, attributes=rx, fill=0) { }
            }
