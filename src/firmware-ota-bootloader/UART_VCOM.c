...
/*-------------------------------------------------Global variables--------------------------------------------------*/
/*********************************************************************************************************************/
IfxAsclin_Asc g_ascPrint;                                                        /* Declaration of the ASC handle        */
 ...
 */
uint8 g_ascTxBufferPrint[ASC_TX_BUFFER_SIZE + sizeof(Ifx_Fifo) + 8];             /* Declaration of the FIFOs parameters  */
...
void init_UART(void)
{
    ...
    /* FIFO configuration */
    ascConfig.txBuffer = &g_ascTxBufferPrint;
    ...
    IfxAsclin_Asc_initModule(&g_ascPrint, &ascConfig);                       /* Initialize module with above parameters  */
}