...
#define OTA_PFLASH_TYPE     IfxFlash_FlashType_P1
...
#define ERASEWRAPPER_LEN    0x100
#define WRITEWRAPPER_LEN    0x200
...
typedef struct
{
    ...
    void  (*eraseWrapper) (uint32 sectorAddr, uint32 sectorCount);
    void  (*writePageFull)(uint32 pageAddr, uint8 *buf);
} OTA_FlashFunc;
